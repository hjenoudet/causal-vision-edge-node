...
1. **Thermodynamic Data Fusion:** Fetches **live weather conditions** and 14-day rolling trends ([Open-Meteo API](https://open-meteo.com/)) to calculate the current local Vapor Pressure Deficit (VPD).
